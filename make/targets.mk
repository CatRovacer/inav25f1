...
F1_TARGETS      = $(F103_TARGETS)
F3_TARGETS      = $(F303_TARGETS)
F4_TARGETS      = $(F405_TARGETS) $(F411_TARGETS) $(F427_TARGETS) $(F446_TARGETS)
F7_TARGETS      = $(F7X2RE_TARGETS) $(F7X5XE_TARGETS) $(F7X5XG_TARGETS) $(F7X5XI_TARGETS) $(F7X6XG_TARGETS)

#$(error Just to seek VALID_TARGET: $(VALID_TARGETS))
#$(error Just to seek F4103_TARGETS: $(F103_TARGETS))
...
GROUP_4_TARGETS := ANYFC ANYFCF7 ANYFCF7_EXTERNAL_BARO ALIENFLIGHTNGF7 PIXRACER YUPIF7 MATEKF405SE MATEKF411 MATEKF411TE MATEKF722 MATEKF405OSD MATEKF405_SERVOS6 NOX
...
GROUP_9_TARGETS := NAZE
GROUP_OTHER_TARGETS := $(filter-out $(GROUP_1_TARGETS) $(GROUP_2_TARGETS) $(GROUP_3_TARGETS) $(GROUP_4_TARGETS) $(GROUP_5_TARGETS) $(GROUP_6_TARGETS) $(GROUP_7_TARGETS) $(GROUP_8_TARGETS) $(GROUP_9_TARGETS), $(VALID_TARGETS))
...
targets:
	...
	$(V0) @echo "targets-group-9:    $(GROUP_9_TARGETS)"
